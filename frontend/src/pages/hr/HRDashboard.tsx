            ...
            <main className="flex-grow bg-background p-8">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid gap-6 md:grid-cols-2 max-w-2xl">
                        ...
                        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => navigate('/hr/professional-development')}>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-muted-foreground">Training & Certifications</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
