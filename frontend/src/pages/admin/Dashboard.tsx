  ...
  return (
    <div className={`card bg-card shadow-xl rounded-lg p-8 w-full max-w-md border-t-4 ${roleColor}`}>
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-xs pt-4">This is the main content area for the admin dashboard. The navbar above is configured with admin-specific links.</p>
      </div>
    </div>
  );
};
